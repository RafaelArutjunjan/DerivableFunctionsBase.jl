...
"""
function Builder(Fexpr::Union{<:AbstractArray{T},T}, args...; inplace::Bool=false, parallel::Bool=false, 
                parallelization=parallel ? Symbolics.MultithreadedForm() : Symbolics.SerialForm(), kwargs...) where T<:SymbolicScalar
